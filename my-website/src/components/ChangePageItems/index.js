...
const ChangePageItems = (props) => {
    return (
        <div id="changePageMenu" className="w-2/3 flex flex-col text-center text-3xl self-center bg-dark-primary border-2 border-t-0 rounded-b-md origin-top open-scroll overflow-y-hidden">

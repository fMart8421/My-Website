    ...
    <div className="container mt-16">
      <div className="grid grid-cols-12 gap-x-16">
        <div className="text-justify col-span-9">
          ...
          className="text-3xl fade-in"><span className="text-fuchsia-300 text-4xl">Hello there, welcome to the hidden page!</span> As I've said before, my name is Fábio Martins, nickname Fabitu (my friends call me that because I'm tall).</p>
          <p 
